/*
 * TeensyOscuino — Oscuino over SLIP-encoded USB serial, for Teensy 4.0 / 4.1
 * -----------------------------------------------------------------------------
 * GENERATED FILE — do not edit directly.
 * Source: extras/webserial/template.ino  +  extras/webserial/boards.json
 * Regenerate:  cd extras/webserial && make generate
 *
 * Board : Teensy 4.0 / 4.1 (i.MX RT1062)
 * FQBN  : teensy:avr:teensy40
 *
 * 14 analog inputs and PWM on most digital pins. The USB stack ignores the baud rate entirely.
 *
 * Pair this with TeensyOscuino.html, sitting next to this file. Serve that page
...
void setup() {
  ...
  delay(300);
  bundleOUT.add("/hello").add("TeensyOscuino");
