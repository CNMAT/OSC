/*
 * LilyPadOscuino — Oscuino over SLIP-encoded USB serial, for LilyPad Arduino USB
 * -----------------------------------------------------------------------------
 * GENERATED FILE — do not edit directly.
 * Source: extras/webserial/template.ino  +  extras/webserial/boards.json
 * Regenerate:  cd extras/webserial && make generate
 *
 * Board : LilyPad Arduino USB (ATmega32U4)
 * FQBN  : arduino:avr:LilyPadUSB
 *
 * Sew tabs are A2-A5 and D2, D3, D9, D10, D11. D9/D10/D11 are the PWM-capable tabs — send a float to /d/<pin> for analogWrite.
 *
 * Pair this with LilyPadOscuino.html, sitting next to this file. Serve that page
...
void setup() {
  ...
  delay(300);
  bundleOUT.add("/hello").add("LilyPadOscuino");
