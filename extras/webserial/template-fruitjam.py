# {{ID}}Oscuino -- Oscuino over SLIP-encoded USB serial, in CircuitPython,
# for the {{NAME}} ({{MCU}}).
#
...
# then press reset; open {{ID}}Oscuino.html next to this file -- served over
...
# SLIP frames. The hand-written Arduino twin in examples/{{ID}}Oscuino
...
def run():
    ...
    try:
        ...
        print('{{ID}}Oscuino: OSC over SLIP over USB serial')
    except Exception:
