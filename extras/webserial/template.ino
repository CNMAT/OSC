/*
 * {{ID}}Oscuino — Oscuino over SLIP-encoded USB serial, for {{NAME}}
 * -----------------------------------------------------------------------------
 ...
 * {{NOTE}}
 *
 * Pair this with {{ID}}Oscuino.html, sitting next to this file. Serve that page
...
void setup() {
  ...
  delay(300);
  bundleOUT.add("/hello").add("{{ID}}Oscuino");
