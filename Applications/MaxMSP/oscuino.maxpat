...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.0, 483.0, 150.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 403.0, 150.0, 22.0 ],
					"text" : "Serial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 459.0, 150.0, 22.0 ],
					"text" : "Ethernet"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 62.0, 453.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 408.0, 288.0, 22.0 ],
...
,
					"patching_rect" : [ 485.0, 279.0, 145.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 18.0, 14.0, 792.0, 181.0 ],
...
,
					"patching_rect" : [ 784.5, 272.0, 86.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 556.0, 355.0, 148.0, 39.0 ],
									"text" : "detach servo #2\nfrom pin 7"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 191.0, 355.0, 148.0, 39.0 ],
									"text" : "detach servo #1\nfrom pin 6"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 2.0, 14.0, 792.0, 197.0 ],
...
,
					"patching_rect" : [ 694.5, 272.0, 69.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 697.0, 348.0, 150.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 436.0, 298.0, 133.0 ],
					"text" : "/ports \"Bluetooth-PDA-Sync\" \"Bluetooth-Modem\" \"MotorolaPhone-DialupNet-1\" \n/rate/output 0 \n/rate/input 0 \n/mediansize/received \n/port \"a\" \n/baudrate 115200 \n",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 352.0, 127.0, 20.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 312.0, 221.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 382.5, 448.0, 128.0, 22.0 ],
					"text" : "s from_oscuino"
				}
...
,
					"patching_rect" : [ 289.5, 280.0, 179.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 43.0, 388.0, 66.0, 20.0 ],
									"text" : "qmetro 5"
								}
...
,
					"patching_rect" : [ 61.5, 281.0, 86.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 198.0, 275.0, 78.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.5, 95.0, 150.0, 22.0 ],
					"text" : "USAGE:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 371.5, 369.0, 212.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "oscuino sends and receives OSC bundles over SLIPSerial and Ethernet to and from an Arduino or Teensy\nrunning the oscuinoSerial or oscuino Ethernet Sketch \n\n"
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/adrian/Desktop/nearfinal/examples/Communication/MaxMSP",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
